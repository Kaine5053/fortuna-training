...
(`support@fortunacivilsltd.co.uk`, to be created by Kaine; owed item) so replies are readable by the
...
1. Create `support@fortunacivilsltd.co.uk` and an Azure app registration with `Mail.Send`,
